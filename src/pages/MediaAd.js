    ...
    { loading ? <div> <SubmitLoader /></div> : <div>
      <div className="m-6 p-5 bg-slate-200 border-black">
        ...
        <div className="flex flex-row ">
            <div className="flex w-1/3 flex-col gap-1 px-5 pt-5 "> 
              <span className="pb-1">Landscape Marketing Image (1.9:1)</span>
              <Input type="text" placeholder="Add the URL of the Image you want to use for the ad"/>
            </div>
            <div className="flex w-1/3 flex-col gap-1 px-5 pt-5 "> 
              <span className="pb-1">Portrait Marketing Image(4:5)</span>
              <Input type="text" placeholder="Add the URL of the Image you want to use for the ad"/>
            </div>
            <div className="flex w-1/3 flex-col gap-1 px-5 pt-5 "> 
              <span className="pb-1">Square markating Image (1:1)</span>
              <Input type="text" placeholder="Add the URL of the Image you want to use for the ad"/>
            </div>
            </div>

            <div className="flex flex-col w-full gap-2 px-5 pt-5">
             <span className="">Video URL</span>
             <Input type="text" placeholder="Add the URL of the Video page you want to use for the ad"/>
            </div>
            <div className="flex flex-row ">
            ...
            <div className="flex flex-col w-full gap-1 px-5 pt-5">
